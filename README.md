...
## Installation
 ...
 First clone the files from my GitHub Profile Repository: [https://github.com/Afrozez/weather-dashboard] (https://github.com/Afrozez/professional-readme-generator). To us this project you must locate and go to the downloaded file inside of the console and enter "npm install". Also It's recommended to install Visual Studio Code: https://code.visualstudio.com and the latest version of the Chrome browser.
